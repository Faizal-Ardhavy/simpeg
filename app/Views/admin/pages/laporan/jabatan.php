...
<head>
	...
	<title>
		SIMPEG - Laporan Rekapitulasi Jabatan
	</title>
	<!-- Fonts -->
				...
				<div class="rounded">
					<header>
						...
						<div class="title fw-bold">
							<h3 class="text-title text-center text-info text-gradient">Laporan Rekapitulasi Jabatan Pegawai</h3>
						</div>
					</header>
					<div id="print">
						...
						<h5 class="mt-4 text-uppercase fw-bold badge bg-gradient-info">Data Jabatan Pegawai</h5>
						<div class="container-fluid card pt-3">
