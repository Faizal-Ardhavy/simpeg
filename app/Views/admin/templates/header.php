	...
	<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
		...
		<div class="sidenav-header">
			...
			<a class="navbar-brand m-0" href="/adminDashboard">
				...
				<span class="ms-1 font-weight-bold">Portal Admin</span>
			</a>
		</div>
				...
				<li class="nav-item">
					<a class="nav-link" href="/AdminPayroll">
						<div
							...
							<svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
								xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
								<title>Data Jabatan dan Gaji</title>
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						...
						<span class="nav-link-text ms-1">Data Jabatan dan Gaji</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/AdminPresensi">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		...
		<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky"
			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
					...
					<h6 class="font-weight-bolder mb-0 text-capitalize"><?=uri_string()?></h6>	
				</nav>
					...
					<ul class="navbar-nav justify-content-end">
						<li class="nav-item dropdown pe-2 d-flex align-items-center">
							<a href="javascript:;" class="nav-link text-body font-weight-bold px-0"
								...
								<span class="d-sm-inline d-none text-capitalize"><?= session()->get('name'); ?></span>
							</a>
							<ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
								aria-labelledby="dropdownMenuButton">
								<li class="mb-2">
									<div
										class="d-flex py-1 flex-column justify-content-center text-xs text-secondary mb-0">
